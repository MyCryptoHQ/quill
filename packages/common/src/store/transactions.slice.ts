...
import type { SliceState, TAddress, TxHistoryEntry, TxQueueEntry } from '../types';
...
export const getQueue = createSelector(
  (state: SliceState<typeof slice>) => state.transactions,
...
export const getCurrentTransaction = createSelector(
  (state: SliceState<typeof slice>) => state.transactions.currentTransaction,
  (t) => t
);
...
export const getTxHistory = createSelector(
  (state: SliceState<typeof slice>) => state.transactions.history,
  (h) => h
);
