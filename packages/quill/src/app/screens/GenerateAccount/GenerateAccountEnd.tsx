...
export const GenerateAccountEnd = ({ onReset }: IFlowComponentProps) => (
  <>
    <Container>
      <Box>
        <Logo width="64px" height="64px" mx="auto" />
        <SubHeading mt="3" mb="3" textAlign="center">
          {translateRaw('GENERATE_ACCOUNT_END_HEADER')}
        </SubHeading>
        <Body mb="3">{translateRaw('GENERATE_ACCOUNT_END_BODY_1')}</Body>
